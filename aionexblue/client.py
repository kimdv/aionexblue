...
def _parse_charger_config_status(raw: dict[str, Any]) -> ChargerConfigStatus:
    try:
        return ChargerConfigStatus(
            ...
            cable_current_limit=raw["cable_current_limit"],
            circuit_fuse=raw["circuit_fuse"],
            current_limit=raw["current_limit"],
            cable_lock_mode=CableLockModeEnum(raw["cable_lock_mode"]),
            access_level=AccessLevelEnum(raw["access_level"]),
            phase_charging=PhaseChargingEnum(raw["phase_charging"]),
